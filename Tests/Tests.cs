...
namespace Tests
{
    public class Tests
    {
        ...
        public void TestCastling()
        {
            ...
            Assert.True(removed.Type == PieceType.Rook);
            Assert.True(board[new(2, 7)].Type == PieceType.King);
            Assert.True(board[new(3, 7)].Type == PieceType.Rook);
            Assert.True(!board.GetCastling(Side.White));

            board.ReverseMove(move1, removed);
            Assert.True(board[new(2, 7)].Type == PieceType.Null);
            Assert.True(board[new(3, 7)].Type == PieceType.Null);
            Assert.True(board[new(4, 7)].Type == PieceType.King);
            Assert.True(board[new(0, 7)].Type == PieceType.Rook);
            Assert.True(board.GetCastling(Side.White));
            ...
            Assert.True(removed.Type == PieceType.Rook);
            Assert.True(board[new(6, 7)].Type == PieceType.King);
            Assert.True(board[new(5, 7)].Type == PieceType.Rook);
            Assert.True(!board.GetCastling(Side.White));

            board.ReverseMove(move2, removed);
            Assert.True(board[new(6, 7)].Type == PieceType.Null);
            Assert.True(board[new(5, 7)].Type == PieceType.Null);
            Assert.True(board[new(4, 7)].Type == PieceType.King);
            Assert.True(board[new(7, 7)].Type == PieceType.Rook);
            Assert.True(board.GetCastling(Side.White));
        ...
        {
            Piece whitePawn = new(PieceType.Pawn, Side.White, new(0, 1));
            Piece blackPawn = new(PieceType.Pawn, Side.Black, new(0, 6));
            ...
            Assert.True(board[new(0, 0)].Type == PieceType.Queen);

            board.ReverseMove(whitePawnMove, Piece.Null);
            Assert.True(board[new(0, 1)].Type == PieceType.Pawn);

            Move blackPawnMove = new(blackPawn, new(0, 7));
            board.MakeMove(blackPawnMove, out _);
            Assert.True(board[new(0, 7)].Type == PieceType.Queen);

            board.ReverseMove(blackPawnMove, Piece.Null);
            Assert.True(board[new(0, 6)].Type == PieceType.Pawn);
        }
    }
}